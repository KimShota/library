...
// Description  : Main program for Library Catalog Management System
//============================================================================
#include<iostream>
#include <sstream>
#include <string>
...
//Call listCommands to display the available commands for user 
void listCommands();

int main()
{
	//Initialize the program with the name "Library"
	LCMS lcms("Library");
	listCommands();
...
//Function to display the available commands for user 
void listCommands()
{
	cout<<" ===================================================================================="<<endl
